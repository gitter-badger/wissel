...
namespace openloco::gfx
{
     ...
     * @return
     */
    bool window_draw_split(gfx::drawpixelinfo_t* dpi, ui::window* w, int16_t left, int16_t top, int16_t right, int16_t bottom)
    {
        // Divide the draws up for only the visible regions of the window recursively
        for (auto index = ui::WindowManager::indexOf(w) + 1; index < ui::WindowManager::count(); index++)
        {
